export const ErrorsMessages = {
    PRODUCTS_NOT_FOUND: 'Product not found with the id provided',
    CART_NOT_FOUND: 'Cart not found with the id provided',
...
export const ErrorsNames = {
    ...
    PRODUCT_ALREADY_EXISTS: 'PRODUCT_ALREADY_EXISTSs',
